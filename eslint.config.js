          ...
          paths: [
            {
              ...
              message:
                'Please use the helpers from @google/deepseek-cli-core instead of node:os homedir()/tmpdir() to ensure strict environment isolation.',
            },
            {
              name: 'os',
              importNames: ['homedir', 'tmpdir'],
              message:
                'Please use the helpers from @google/deepseek-cli-core instead of os homedir()/tmpdir() to ensure strict environment isolation.',
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@google/deepseek-cli-core',
          message: 'Please use relative imports within the @google/deepseek-cli-core package.',
        },
      ],
    },
  },
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          ...
          message: 'Please use relative imports within the @google/deepseek-cli package.',
        },
      ],
    },
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          name: '@google/deepseek-cli-sdk',
          message: 'Please use relative imports within the @google/deepseek-cli-sdk package.',
        },
      ],
    },
  },
