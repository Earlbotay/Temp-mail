...
name: ci
description:
  A specialized skill for DeepSeek CLI that provides high-performance, fail-fast
...
- **Tool**: `node .deepseek/skills/ci/scripts/ci.mjs [branch]`
...
- **Tool**: `node .deepseek/skills/ci/scripts/ci.mjs [branch] [run_id]`
- **Discovery**: The script **automatically** finds the latest active or recent
