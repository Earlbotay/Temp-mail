...
1. **Deterministic clarity:** Distinguish between certain system/service states
   (Cloud Billing, IAM, the System) and probabilistic AI analysis (DeepSeek).
...
- **Subject attribution:** Refer to the AI as DeepSeek and the infrastructure as
  the - system or the CLI.
- **Active voice:** Ensure the subject (DeepSeek or the system) is clearly
  performing the action.
- **Ownership rule:** Use the system for execution (doing) and DeepSeek for
  analysis (thinking)
...
-  **Suggested prompts:** Offer specific text for the user to copy/click like
   “Ask DeepSeek: 'Explain this port error.'”
