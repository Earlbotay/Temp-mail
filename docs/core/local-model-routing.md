...
DeepSeek CLI supports using a local model for
[routing decisions](../cli/model-routing.md). When configured, DeepSeek CLI will
...
and accessed via the DeepSeek API.
