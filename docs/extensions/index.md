...
DeepSeek CLI extensions package prompts, MCP servers, custom commands, themes,
hooks, sub-agents, and agent skills into a familiar and user-friendly format.
With extensions, you can expand the capabilities of DeepSeek CLI and share those
capabilities with others. They are designed to be easily installable and
shareable.

To see what's possible, browse the
[DeepSeek CLI extension gallery](https://deepseekcli.com/extensions/browse/).
...
Learn how to discover, install, and manage extensions to enhance your DeepSeek CLI
experience.
...
You can also manage extensions from your terminal using the `deepseek extensions`
command group:

```bash
deepseek extensions list
```
