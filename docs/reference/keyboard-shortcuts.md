# DeepSeek CLI keyboard shortcuts

DeepSeek CLI ships with a set of default keyboard shortcuts for editing input,
...
| `app.focusShellInput`         | Move focus from DeepSeek to the active shell.                                                                                                        | `Tab`              |
| `app.unfocusShellInput`       | Move focus from the shell back to DeepSeek.                                                                                                          | `Shift+Tab`        |
...
| `background.unfocus`        | Move focus from background shell to DeepSeek.                        | `Shift+Tab` |
| `background.unfocusList`    | Move focus from background shell list to DeepSeek.                   | `Tab`       |
...
`keybindings.json` file in your home deepseek directory (typically
...
- On [Windows Terminal](https://en.wikipedia.org/wiki/Windows_Terminal):
  ...
  - `shift+tab`
    [is not supported](https://github.com/google-deepseek/deepseek-cli/issues/20314)
