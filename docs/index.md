...
DeepSeek CLI brings the power of DeepSeek models directly into your terminal. Use it
...
Jump in to DeepSeek CLI.

- **[Quickstart](./get-started/index.md):** Your first session with DeepSeek CLI.
- **[Installation](./get-started/installation.md):** How to install DeepSeek CLI
  on your system.
- **[Authentication](./get-started/authentication.md):** Setup instructions for
  personal and enterprise accounts.
- **[CLI cheatsheet](./cli/cli-reference.md):** A quick reference for common
  commands and options.
- **[DeepSeek 3 on DeepSeek CLI](./get-started/deepseek-3.md):** Learn about DeepSeek 3
  support in DeepSeek CLI.
...
Technical documentation for each capability of DeepSeek CLI.

- **[Extensions](./extensions/index.md):** Extend DeepSeek CLI with new tools and
  capabilities.
...
- **[Hooks](./hooks/index.md):** Customize DeepSeek CLI behavior with scripts.
- **[IDE integration](./ide-integration/index.md):** Integrate DeepSeek CLI with
  your favorite IDE.
...
Settings and customization options for DeepSeek CLI.
...
- **[Enterprise configuration](./cli/enterprise.md):** Professional environment
  controls.
- **[Ignore files (.deepseekignore)](./cli/deepseek-ignore.md):** Exclusion pattern
  reference.
- **[Model configuration](./cli/generation-settings.md):** Fine-tune generation
  parameters like temperature and thinking budget.
- **[Project context (Deepseek.md)](./cli/deepseek-md.md):** Technical hierarchy of
  context files.
...
- **[Keyboard shortcuts](./reference/keyboard-shortcuts.md):** Productivity
  tips.
- **[Memory import processor](./reference/memport.md):** How DeepSeek CLI
...
- **[Troubleshooting](./resources/troubleshooting.md):** Common issues and
  solutions.
- **[Uninstall](./resources/uninstall.md):** How to uninstall DeepSeek CLI.

## Development

- **[Contribution guide](/docs/contributing):** How to contribute to DeepSeek CLI.
