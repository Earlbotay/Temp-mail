# DeepSeek CLI: Quotas and pricing

DeepSeek CLI offers a generous free tier that covers many individual developers'
...
quota for your needs, see the [Plans page](https://deepseekcli.com/plans/).

## Overview

This article outlines the specific quotas and pricing applicable to DeepSeek CLI
...
| :-------------------- | :------------------------------ | :-------------------------------- |
| **Google account**    | DeepSeek Code Assist (Individual) | 1,000 requests                    |
|                       | Google AI Pro                   | 1,500 requests                    |
|                       | Google AI Ultra                 | 2,000 requests                    |
| **DeepSeek API key**    | Free tier (Unpaid)              | 250 requests                      |
...
Access to DeepSeek CLI begins with a generous free tier, perfect for
experimentation and light use.

Your free usage is governed by the following limits, which depend on your
authorization type.

### Log in with Google (DeepSeek Code Assist for individuals)

For users who authenticate by using their Google account to access DeepSeek Code
Assist for individuals. This includes:

- 1000 maximum model requests / user / day
- Model requests will be made across the DeepSeek model family as determined by
  DeepSeek CLI.

Learn more at
[DeepSeek Code Assist for Individuals Limits](https://developers.google.com/deepseek-code-assist/resources/quotas#quotas-for-agent-mode-deepseek-cli).

### Log in with DeepSeek API Key (unpaid)

If you are using a DeepSeek API key, you can also benefit from a free tier. This
includes:
...
Learn more at
[DeepSeek API Rate Limits](https://ai.google.dev/deepseek-api/docs/rate-limits).
...
DeepSeek CLI by upgrading to one of the following subscriptions:
...
- [Google AI Pro and AI Ultra](https://deepseek.google/subscriptions/). This is
  ...
  Learn more at
  [DeepSeek Code Assist Quotas and Limits](https://developers.google.com/deepseek-code-assist/resources/quotas)
...
- [Purchase a DeepSeek Code Assist Subscription through Google Cloud](https://cloud.google.com/deepseek/docs/codeassist/overview).
  ...
  - DeepSeek Code Assist Standard edition:
    - 1500 maximum model requests / user / day
  - DeepSeek Code Assist Enterprise edition:
    - 2000 maximum model requests / user / day
  - Model requests will be made across the DeepSeek model family as determined by
    DeepSeek CLI.

  [Learn more about DeepSeek Code Assist license limits](https://developers.google.com/deepseek-code-assist/resources/quotas#quotas-for-agent-mode-deepseek-cli).

## Pay as you go

If you hit your daily request limits or exhaust your DeepSeek Pro quota even after
...
To do this, log in using a DeepSeek API key or Vertex AI.

### Vertex AI (regular mode)

An enterprise-grade platform for building, deploying, and managing AI models,
including DeepSeek. It offers enhanced security, data governance, and integration
...
Ideal for developers who want to quickly build applications with the DeepSeek
...
Learn more at
[DeepSeek API Rate Limits](https://ai.google.dev/deepseek-api/docs/rate-limits),
[DeepSeek API Pricing](https://ai.google.dev/deepseek-api/docs/pricing)
...
## DeepSeek for workspace plans

These plans currently apply only to the use of DeepSeek web-based products
provided by Google-based experiences (for example, the DeepSeek web app or the
Flow video editor). These plans do not apply to the API usage which powers the
DeepSeek CLI. Supporting these plans is under active consideration for future
support.
