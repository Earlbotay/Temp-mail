...
The `activate_skill` tool lets DeepSeek CLI load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. DeepSeek CLI uses this
...
The `activate_skill` tool is used exclusively by the DeepSeek agent. You cannot
