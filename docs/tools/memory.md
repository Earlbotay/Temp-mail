...
The `save_memory` tool allows the DeepSeek agent to persist specific facts, user
preferences, and project details across sessions.

## Technical reference

This tool appends information to the `## DeepSeek Added Memories` section of your
global `Deepseek.md` file (typically located at `~/.deepseek/Deepseek.md`).
...
- Learn how the [Project context (Deepseek.md)](../cli/deepseek-md.md) system loads
  this information.
