...
Keep complex jobs on the rails with DeepSeek CLI's built-in task planning. In this
...
DeepSeek will analyze your codebase and use the `write_todos` tool to generate a
structured list.
