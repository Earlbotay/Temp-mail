...
Resume, browse, and rewind your conversations with DeepSeek CLI. In this guide,
...
on a different feature. DeepSeek makes it easy to jump back in.
...
deepseek --delete-session 1
```

## How to rewind time (Undo mistakes)

DeepSeek CLI's **Rewind** feature is like `Ctrl+Z` for your workflow.
...
DeepSeek gives you granular control over the undo process. You can choose to:
