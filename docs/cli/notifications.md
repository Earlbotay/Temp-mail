...
DeepSeek CLI can send system notifications to alert you when a session completes
...
[Plan Mode](./plan-mode.md), letting you switch to other windows while DeepSeek
...
notifications, DeepSeek CLI falls back to a terminal bell (BEL) to get your
...
DeepSeek CLI sends notifications for the following events:
