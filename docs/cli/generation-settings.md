...
This guide details the Model Configuration system within the DeepSeek CLI.
...
| :---------------------- | :------- | :----------------------------------------------------------------- |
| `model`                 | `string` | The identifier of the model to be called (e.g., `deepseek-2.5-pro`). |
  ...
  "overrides": [
    {
      ...
      "modelConfig": {
        "model": "deepseek-2.5-pro-experimental-001"
      }
    }
  ]
}
