...
Model steering lets you provide real-time guidance and feedback to DeepSeek CLI
...
1.  Type `/settings` in the DeepSeek CLI.
...
When model steering is enabled, DeepSeek CLI treats any text you type while the
...
DeepSeek CLI acknowledges your hint with a brief message and injects it directly
...
When you submit a steering hint, DeepSeek CLI performs the following actions:
