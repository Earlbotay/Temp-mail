# DeepSeek CLI settings (`/settings` command)

Control your DeepSeek CLI experience with the `/settings` command. The `/settings`
command opens a dialog to view and edit all your DeepSeek CLI settings, including
your UI experience, keybindings, and accessibility features.

Your DeepSeek CLI settings are stored in a `settings.json` file. In addition to
using the `/settings` command, you can also edit them in one of the following
locations:

- **User settings**: `~/.deepseek/settings.json`
- **Workspace settings**: `your-project/.deepseek/settings.json`
...
| Show Thoughts in Title               | `ui.showStatusInTitle`                 | Show DeepSeek CLI model thoughts in the terminal window title during the working phase                                                                              | `false` |
| Dynamic Window Title                 | `ui.dynamicWindowTitle`                | Update the terminal window title with current status icons (Ready: ◇, Action Required: ✋, Working: ✦)                                                            | `true`  |
| Show Home Directory Warning          | `ui.showHomeDirectoryWarning`          | Show a warning when running DeepSeek CLI in the home directory.                                                                                                     | `true`  |
...
| Hide Context Summary                 | `ui.hideContextSummary`                | Hide the context summary (Deepseek.md, MCP servers) above the input.                                                                                                | `false` |
...
| UI Label                      | Setting                      | Description                                                                            | Default     |
| ----------------------------- | ---------------------------- | -------------------------------------------------------------------------------------- | ----------- |
| Model                         | `model.name`                 | The DeepSeek model to use for conversations.                                             | `undefined` |
...
| Load Memory From Include Directories | `context.loadMemoryFromIncludeDirectories`        | Controls how /memory reload loads Deepseek.md files. When true, include directories are scanned; when false, only the current directory is used.                                                                                              | `false` |
| Respect .gitignore                   | `context.fileFiltering.respectGitIgnore`          | Respect .gitignore files when searching.                                                                                                                                                                                                    | `true`  |
| Respect .deepseekignore                | `context.fileFiltering.respectDeepSeekIgnore`       | Respect .deepseekignore files when searching.                                                                                                                                                                                                 | `true`  |
...
| Custom Ignore File Paths             | `context.fileFiltering.customIgnoreFilePaths`     | Additional ignore file paths to respect. These files take precedence over .deepseekignore and .gitignore. Files earlier in the array take precedence over files later in the array, e.g. the first file takes precedence over the second one. | `[]`    |
