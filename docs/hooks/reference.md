...
This document provides the technical specification for DeepSeek CLI hooks,
...
DeepSeek CLI uses these structures to ensure hooks don't break across SDK updates.
