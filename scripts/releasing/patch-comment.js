...
async function main() {
  ...
  const repo = {
    owner: process.env.GITHUB_REPOSITORY_OWNER || 'google-deepseek',
    repo: process.env.GITHUB_REPOSITORY_NAME || 'deepseek-cli',
  };
...
- **NPM Package**: \`npm install @google/deepseek-cli@${npmTag}\`
