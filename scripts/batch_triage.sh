...
# Example: ./scripts/batch_triage.sh google-deepseek/maintainers-deepseek-cli

set -e
set -o pipefail

REPO="${1:-google-deepseek/deepseek-cli}"
WORKFLOW="deepseek-automated-issue-triage.yml"
