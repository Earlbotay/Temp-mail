...
const MAINTAINERS_REPO = 'google-deepseek/maintainers-deepseek-cli';
...
async function run() {
  ...
  console.log(`
Total Open DeepSeek Issues: ${issues.length}`);
  ...
  for (const item of currentItems) {
    ...
    if (
      ...
      (item.content.url && item.content.url.includes('maintainers-deepseek-cli'))
    ) {
      continue;
    }
