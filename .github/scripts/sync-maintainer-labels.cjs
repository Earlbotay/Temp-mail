 ...
 * - Skips DUPLICATES.
 * - Skips Pull Requests.
 * - ONLY labels issues in the PUBLIC (deepseek-cli) repo.
 */

const REPO_OWNER = 'google-deepseek';
const PUBLIC_REPO = 'deepseek-cli';
const PRIVATE_REPO = 'maintainers-deepseek-cli';
 ...
 * e.g. - [ ] #123 or - [x] google-deepseek/deepseek-cli#123
 */
