...
export const createMockConfig = (overrides: Partial<Config> = {}): Config =>
  ({
    ...
    storage: {
      getProjectTempDir: vi.fn().mockReturnValue('/tmp/deepseek-test'),
    ...
    getDeepSeekMdFilePaths: vi.fn().mockReturnValue([]),
    ...
    getFileFilteringRespectDeepSeekIgnore: vi.fn().mockReturnValue(true),
