...
import { isWithinRoot, type FileSystemService } from '@google/deepseek-cli-core';
...
export class AcpFileSystemService implements FileSystemService {
  private readonly deepseekDir = path.join(os.homedir(), '.deepseek');
  ...
  private shouldUseFallback(filePath: string): boolean {
    ...
    return (
      ...
      isWithinRoot(filePath, this.deepseekDir)
    );
  }
