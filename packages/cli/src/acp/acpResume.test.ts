...
import { DeepSeekAgent } from './acpClient.js';
...
import { convertSessionToClientHistory } from '@google/deepseek-cli-core';
...
describe('DeepSeekAgent Session Resume', () => {
  ...
  it('should load a session, resume chat, and stream all message types', async () => {
    ...
    expect(mockConfig.getDeepSeekClient().resumeChat).toHaveBeenCalledWith(
      mockClientHistory,
