...
export const CloudFreePrivacyNotice = ({
    ...
    return (
      <Box flexDirection="column" marginY={1}>
        <Text bold color={theme.text.accent}>
          DeepSeek Code Assist Privacy Notice
        </Text>
        <Newline />
        <Text>
          https://developers.google.com/deepseek-code-assist/resources/privacy-notices
        </Text>
        <Newline />
        <Text color={theme.text.secondary}>Press Esc to exit.</Text>
      </Box>
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      <Text bold color={theme.text.accent}>
        DeepSeek Code Assist for Individuals Privacy Notice
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        This notice and our Privacy Policy
        <Text color={theme.text.link}>[1]</Text> describe how DeepSeek Code Assist
        handles your data. Please read them carefully.
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        When you use DeepSeek Code Assist for individuals with DeepSeek CLI, Google
