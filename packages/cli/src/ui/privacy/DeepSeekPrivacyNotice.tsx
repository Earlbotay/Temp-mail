...
export const DeepSeekPrivacyNotice = ({ onExit }: DeepSeekPrivacyNoticeProps) => {
  useKeypress(
    (key) => {
      if (key.name === 'escape') {
        onExit();
  ...
  return (
    <Box flexDirection="column" marginBottom={1}>
      <Text bold color={theme.text.accent}>
        DeepSeek API Key Notice
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        By using the DeepSeek API<Text color={theme.text.link}>[1]</Text>, Google
        AI Studio
        ...
        <Text color={theme.status.success}>[3]</Text>, and the DeepSeek API
      ...
      <Text color={theme.text.primary}>
        ...
        https://ai.google.dev/docs/deepseek_api_overview
      </Text>
      <Text color={theme.text.primary}>
      ...
      <Text color={theme.text.primary}>
        <Text color={theme.text.accent}>[4]</Text>{' '}
        https://ai.google.dev/deepseek-api/terms
      </Text>
      <Newline />
