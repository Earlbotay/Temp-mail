...
vi.mock('./DeepSeekPrivacyNotice.js', async () => {
  const { Text } = await import('ink');
  return {
    DeepSeekPrivacyNotice: () => <Text>DeepSeekPrivacyNotice</Text>,
  };
});
...
describe('PrivacyNotice', () => {
  ...
  it.each([
    {
      authType: 'deepseek-api-key' as AuthType,
      expectedComponent: 'DeepSeekPrivacyNotice',
    },
    {
