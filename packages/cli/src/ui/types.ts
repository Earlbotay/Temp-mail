...
export interface HistoryItemBase {
  text?: string; // Text content for user/deepseek/info/error messages
}
...
export type HistoryItemDeepSeek = HistoryItemBase & {
  type: 'deepseek';
  text: string;
};

export type HistoryItemDeepSeekContent = HistoryItemBase & {
...
export type HistoryItemExtensionsList = HistoryItemBase & {
  ...
  extensions: DeepSeekCLIExtension[];
};
 ...
 * being submitted to the DeepSeek model.
 */
...
/**
 * Defines the result of the slash command processor for its consumer (useDeepSeekStream).
 */
