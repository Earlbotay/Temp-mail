...
// usage.
export const MAX_DEEPSEEK_MESSAGE_LINES = 65536;
...
export const KEYBOARD_SHORTCUTS_URL =
  'https://deepseekcli.com/docs/cli/keyboard-shortcuts/';
...
export const SKILLS_DOCS_URL =
  'https://github.com/google-deepseek/deepseek-cli/blob/main/docs/cli/skills.md';
