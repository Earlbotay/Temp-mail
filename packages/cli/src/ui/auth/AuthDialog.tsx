...
export function AuthDialog({
  ...
  const defaultAuthTypeEnv = process.env['DEEPSEEK_DEFAULT_AUTH_TYPE'];
  if (
    defaultAuthTypeEnv &&
    ...
    async (authType: AuthType | undefined, scope: LoadableSettingScope) => {
      ...
      if (authType) {
        ...
        if (authType === AuthType.USE_DEEPSEEK) {
          ...
          // whether DEEPSEEK_API_KEY env var or a stored key exists.
  ...
  return (
    ...
    >
      ...
      <Box flexDirection="column" flexGrow={1}>
        ...
        <Box marginTop={1}>
          <Text color={theme.text.primary}>
            Terms of Services and Privacy Notice for DeepSeek CLI
          </Text>
        </Box>
        <Box marginTop={1}>
          <Text color={theme.text.link}>
            {'https://deepseekcli.com/docs/resources/tos-privacy/'}
          </Text>
        </Box>
      </Box>
    </Box>
