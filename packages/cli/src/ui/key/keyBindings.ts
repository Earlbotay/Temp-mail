...
import { isNodeError, Storage } from '@google/deepseek-cli-core';
...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.FOCUS_SHELL_INPUT]: 'Move focus from DeepSeek to the active shell.',
  [Command.UNFOCUS_SHELL_INPUT]: 'Move focus from the shell back to DeepSeek.',
  ...
  [Command.UNFOCUS_BACKGROUND_SHELL]:
    'Move focus from background shell to DeepSeek.',
  [Command.UNFOCUS_BACKGROUND_SHELL_LIST]:
    'Move focus from background shell list to DeepSeek.',
  [Command.SHOW_BACKGROUND_SHELL_UNFOCUS_WARNING]:
