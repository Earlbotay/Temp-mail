...
describe('PolicyUpdateDialog', () => {
  ...
  beforeEach(() => {
    ...
    mockRequest = {
      scope: 'workspace',
      identifier: '/test/workspace/.deepseek/policies',
      policyDir: '/test/workspace/.deepseek/policies',
      newHash: 'test-hash',
  ...
  it('renders correctly and matches snapshot', async () => {
    ...
    expect(output).toContain('Location: /test/workspace/.deepseek/policies');
