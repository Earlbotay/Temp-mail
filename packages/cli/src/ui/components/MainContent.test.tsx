...
import { makeFakeConfig, CoreToolCallStatus } from '@google/deepseek-cli-core';
...
describe('MainContent', () => {
  const defaultMockUiState = {
    history: [
      ...
      { id: 2, type: 'deepseek', text: 'Hi there' },
    ],
    pendingHistoryItems: [],
    mainAreaWidth: 80,
  ...
  it('renders multiple history items with single line padding between them', async () => {
    ...
    const uiState = {
      ...defaultMockUiState,
      history: [
        { id: 1, type: 'deepseek', text: 'DeepSeek message 1\n'.repeat(10) },
        { id: 2, type: 'deepseek', text: 'DeepSeek message 2\n'.repeat(10) },
      ],
  ...
  it('renders mixed history items (user + deepseek) with single line padding between them', async () => {
    vi.mocked(useAlternateBuffer).mockReturnValue(true);
    const uiState = {
      ...defaultMockUiState,
      history: [
        { id: 1, type: 'user', text: 'User message' },
        { id: 2, type: 'deepseek', text: 'DeepSeek response\n'.repeat(10) },
      ],
      constrainHeight: true,
      staticAreaMaxItemHeight: 5,
    };
