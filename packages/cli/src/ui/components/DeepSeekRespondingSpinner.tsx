...
import { DeepSeekSpinner } from './DeepSeekSpinner.js';

interface DeepSeekRespondingSpinnerProps {
  /**
...
export const DeepSeekRespondingSpinner: React.FC<
  DeepSeekRespondingSpinnerProps
> = ({
  ...
  // to be consistent, instead of the rainbow spinner which means "DeepSeek is talking".
