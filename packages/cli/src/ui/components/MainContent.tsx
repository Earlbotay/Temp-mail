...
import { MAX_DEEPSEEK_MESSAGE_LINES } from '../constants.js';
...
// Limit DeepSeek messages to a very high number of lines to mitigate performance
// issues in the worst case if we somehow get an enormous response from DeepSeek.
...
export const MainContent = () => {
      ...
      augmentedHistory.map(
        ({
          ...
          <MemoizedHistoryItemDisplay
            ...
            availableTerminalHeightDeepSeek={MAX_DEEPSEEK_MESSAGE_LINES}
            key={item.id}
            item={item}
            isPending={false}
  ...
  // interactive. DeepSeek messages and Tool results that are not scrollable,
