...
import { DeepSeekMessage } from './messages/DeepSeekMessage.js';
import { InfoMessage } from './messages/InfoMessage.js';
import { ErrorMessage } from './messages/ErrorMessage.js';
import { ToolGroupMessage } from './messages/ToolGroupMessage.js';
import { DeepSeekMessageContent } from './messages/DeepSeekMessageContent.js';
...
import { getMCPServerStatus } from '@google/deepseek-cli-core';
...
interface HistoryItemDisplayProps {
  ...
  availableTerminalHeightDeepSeek?: number;
...
export const HistoryItemDisplay: React.FC<HistoryItemDisplayProps> = ({
  ...
  isPending,
  commands,
  availableTerminalHeightDeepSeek,
  isExpandable,
  ...
  if (
    ...
    (itemForDisplay.type === 'thinking' ||
      itemForDisplay.type === 'deepseek' ||
      itemForDisplay.type === 'deepseek_content')
  ) {
    return null;
  }
    ...
    >
      ...
      {itemForDisplay.type === 'deepseek' && (
        <DeepSeekMessage
          ...
          isPending={isPending}
          availableTerminalHeight={
            availableTerminalHeightDeepSeek ?? availableTerminalHeight
          }
          terminalWidth={terminalWidth}
        />
      )}
