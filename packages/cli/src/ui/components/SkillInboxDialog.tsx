...
const DESTINATION_CHOICES: DestinationChoice[] = [
  {
    destination: 'global',
    label: 'Global',
    description: '~/.deepseek/skills — available in all projects',
  },
  {
    destination: 'project',
    label: 'Project',
    description: '.deepseek/skills — available in this workspace',
  },
  {
    destination: 'dismiss',
    label: 'Dismiss',
        ...
        if (choice.destination === 'project' && !isTrustedFolder) {
          return {
            ...
            value: {
              ...choice,
              description:
                '.deepseek/skills — unavailable until this workspace is trusted',
            },
            disabled: true,
          };
        }
