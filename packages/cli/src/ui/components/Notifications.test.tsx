...
import { WarningPriority } from '@google/deepseek-cli-core';
...
vi.mock('@google/deepseek-cli-core', async (importOriginal) => {
  ...
  const MockStorage = vi.fn().mockImplementation(() => ({
    getExtensionsDir: () => '/mock/home/.deepseek/extensions',
  }));
  Object.assign(MockStorage, {
    getGlobalTempDir: () => '/mock/temp',
    getGlobalSettingsPath: () => '/mock/home/.deepseek/settings.json',
    getGlobalDeepSeekDir: () => '/mock/home/.deepseek',
  });
  return {
    ...actual,
