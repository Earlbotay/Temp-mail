...
import { debugLogger } from '@google/deepseek-cli-core';

export const GITHUB_WORKFLOW_PATHS = [
  'deepseek-dispatch/deepseek-dispatch.yml',
  'deepseek-assistant/deepseek-invoke.yml',
  'deepseek-assistant/deepseek-plan-execute.yml',
  'issue-triage/deepseek-triage.yml',
  'issue-triage/deepseek-scheduled-triage.yml',
  'pr-review/deepseek-review.yml',
];

export const GITHUB_COMMANDS_PATHS = [
  'deepseek-assistant/deepseek-invoke.toml',
  'deepseek-assistant/deepseek-plan-execute.toml',
  'issue-triage/deepseek-scheduled-triage.toml',
  'issue-triage/deepseek-triage.toml',
  'pr-review/deepseek-review.toml',
];

const REPO_DOWNLOAD_URL =
  'https://raw.githubusercontent.com/google-github-actions/run-deepseek-cli';
...
// Add DeepSeek CLI specific entries to .gitignore file
export async function updateGitignore(gitRepoRoot: string): Promise<void> {
  const gitignoreEntries = ['.deepseek/', 'gha-creds-*.json'];
...
export const setupGithubCommand: SlashCommand = {
  ...
  action: async (
    ...
    const readmeUrl = `https://github.com/google-github-actions/run-deepseek-cli/blob/${releaseTag}/README.md#quick-start`;
    ...
    return {
      ...
      toolArgs: {
        description:
          'Setting up GitHub Actions to triage issues and review PRs with DeepSeek.',
        command,
      },
    };
  },
