...
const inactiveExt: DeepSeekCLIExtension = {
  name: 'ext-one',
  id: 'ext-one-id',
  version: '1.0.0',
...
const activeExt: DeepSeekCLIExtension = {
  name: 'ext-two',
  id: 'ext-two-id',
  version: '1.0.0',
...
const allExt: DeepSeekCLIExtension = {
  name: 'all-ext',
  id: 'all-ext-id',
  version: '1.0.0',
  isActive: true,
...
describe('extensionsCommand', () => {
  ...
  describe('explore', () => {
    ...
    it("should add an info message and call 'open' in a non-sandbox environment", async () => {
      ...
      const extensionsUrl = 'https://deepseekcli.com/extensions/';
      expect(mockContext.ui.addItem).toHaveBeenCalledWith({
        type: MessageType.INFO,
    ...
    it('should only add an info message in a sandbox environment', async () => {
      ...
      vi.stubEnv('NODE_ENV', '');
      vi.stubEnv('SANDBOX', 'deepseek-sandbox');
      const extensionsUrl = 'https://deepseekcli.com/extensions/';
