...
import { getAdminErrorMessage, getErrorMessage } from '@google/deepseek-cli-core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload DeepSeek CLI agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',
