...
import { NoopSandboxManager } from '@google/deepseek-cli-core';
...
describe('useExecutionLifecycle', () => {
  ...
  beforeEach(() => {
    ...
    mockDeepSeekClient = { addHistory: vi.fn() } as unknown as DeepSeekClient;
  ...
  it('should handle successful execution and update history correctly', async () => {
    ...
    expect(mockDeepSeekClient.addHistory).toHaveBeenCalled();
  ...
  it('should handle command abort and display cancelled status', async () => {
    ...
    // to avoid duplication/flickering, as they are handled by useDeepSeekStream.
