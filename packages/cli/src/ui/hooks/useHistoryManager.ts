...
import type { ChatRecordingService } from '@google/deepseek-cli-core/src/services/chatRecordingService.js';
    ...
    (
      ...
      if (!isResuming && chatRecordingService) {
        switch (itemData.type) {
          ...
          case 'user':
          case 'deepseek':
          case 'deepseek_content':
            // Core conversation recording handled by DeepSeekChat.
            break;
          default:
            // Ignore the rest.
            break;
