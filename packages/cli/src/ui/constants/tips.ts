...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific DeepSeek model for conversations (/settings)…',
  ...
  'Toggle respect for .deepseekignore files in context (/settings)…',
  ...
  'Show DeepSeek CLI status in the terminal window title (/settings)…',
  ...
  'Create a project-specific Deepseek.md file with /init',
  ...
  'Reload instructional context from Deepseek.md files with /memory reload',
  'List the paths of the Deepseek.md files in use with /memory list',
  'Choose your DeepSeek model with /model',
