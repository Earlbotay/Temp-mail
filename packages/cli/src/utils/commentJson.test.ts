...
import { coreEvents } from '@google/deepseek-cli-core';
...
describe('commentJson', () => {
  ...
  describe('updateSettingsFilePreservingFormat', () => {
    it('should preserve comments when updating settings', () => {
      ...
      expect(updatedContent).toContain('"model": "deepseek-2.5-flash"');
    ...
    it('should create file if it does not exist', () => {
      ...
      expect(content).toContain('"model": "deepseek-2.5-pro"');
    });
