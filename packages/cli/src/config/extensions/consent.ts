...
import { debugLogger, type SkillDefinition } from '@google/deepseek-cli-core';
...
async function extensionConsentString(
  ...
  if (sanitizedConfig.contextFileName) {
    output.push(
      `This extension will append info to your deepseek.md context using ${sanitizedConfig.contextFileName}`,
    );
  }
