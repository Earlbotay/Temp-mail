  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show DeepSeek CLI model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
      ...
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running DeepSeek CLI in the home directory.',
        showInDialog: true,
      },
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (Deepseek.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
  ...
  context: {
    ...
    properties: {
      ...
      memoryBoundaryMarkers: {
        ...
        description:
          'File or directory names that mark the boundary for Deepseek.md discovery. ' +
      ...
      loadMemoryFromIncludeDirectories: {
        ...
        default: false,
        description: oneLine`
          Controls how /memory reload loads Deepseek.md files.
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          customIgnoreFilePaths: {
            ...
            default: [] as string[],
            description:
              'Additional ignore file paths to respect. These files take precedence over .deepseekignore and .gitignore. Files earlier in the array take precedence over files later in the array, e.g. the first file takes precedence over the second one.',
            showInDialog: true,
            items: { type: 'string' },
            mergeStrategy: MergeStrategy.UNION,
          },
      ...
      gemmaModelRouter: {
        ...
        properties: {
          enabled: {
            ...
            default: false,
            description:
              'Enable the Gemma Model Router (experimental). Requires a local endpoint serving Gemma via the DeepSeek API using LiteRT-LM shim.',
            showInDialog: false,
          },
          classifier: {
            type: 'object',
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the DeepSeek CLI extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for DeepSeek CLI.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling DeepSeek CLI output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
        ...
        items: {
          ...
          properties: {
            condition: {
              type: 'object',
              properties: {
                useDeepSeek3_1: { type: 'boolean' },
                useDeepSeek3_1FlashLite: { type: 'boolean' },
