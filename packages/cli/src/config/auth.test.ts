...
import { AuthType } from '@google/deepseek-cli-core';
...
describe('validateAuthMethod', () => {
  ...
  it.each([
    ...
    {
      description: 'should return null for USE_DEEPSEEK if DEEPSEEK_API_KEY is set',
      authType: AuthType.USE_DEEPSEEK,
      envs: { DEEPSEEK_API_KEY: 'test-key' },
      expected: null,
    },
    {
      description:
        'should return an error message for USE_DEEPSEEK if DEEPSEEK_API_KEY is not set',
      authType: AuthType.USE_DEEPSEEK,
      envs: {},
      expected:
