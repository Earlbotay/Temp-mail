...
// File for 'deepseek mcp add' command
import type { CommandModule } from 'yargs';
import { loadSettings, SettingScope } from '../../config/settings.js';
import { debugLogger, type MCPServerConfig } from '@google/deepseek-cli-core';
...
export const addCommand: CommandModule = {
  ...
  builder: (yargs) =>
    yargs
      .usage('Usage: deepseek mcp add [options] <name> <commandOrUrl> [args...]')
      .parserConfiguration({
