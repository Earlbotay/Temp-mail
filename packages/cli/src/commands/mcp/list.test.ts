...
import { createTransport, debugLogger } from '@google/deepseek-cli-core';
  ...
  return {
    ...
    Storage: Object.assign(
      vi.fn().mockImplementation((_cwd: string) => ({
        getGlobalSettingsPath: () => '/tmp/deepseek/settings.json',
        getWorkspaceSettingsPath: () => '/tmp/deepseek/workspace-settings.json',
        getProjectTempDir: () => '/test/home/.deepseek/tmp/mocked_hash',
      })),
      {
        getGlobalSettingsPath: () => '/tmp/deepseek/settings.json',
        getGlobalDeepSeekDir: () => '/tmp/deepseek',
      },
    ),
