...
import { DEEPSEEK_DIR, debugLogger } from '@google/deepseek-cli-core';
...
describe('mcp remove command', () => {
  ...
  describe('integration tests with real file I/O', () => {
    ...
    beforeEach(() => {
      ...
      settingsDir = path.join(tempDir, DEEPSEEK_DIR);
    ...
    it('should preserve other settings when removing a server', async () => {
      ...
      expect(updatedContent).toContain('"deepseek-2.5-pro"');
