...
import { DEFAULT_DEEPSEEK_MODEL, DEFAULT_DEEPSEEK_FLASH_MODEL } from './models.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('getModel', () => {
    it('should return contentGeneratorConfig model if available', () => {
      ...
      config.setModel(DEFAULT_DEEPSEEK_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_DEEPSEEK_FLASH_MODEL);
    });
  ...
  describe('activateFallbackMode', () => {
    it('should set model to fallback and log event', () => {
      config.activateFallbackMode(DEFAULT_DEEPSEEK_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_DEEPSEEK_FLASH_MODEL);
