...
export const EVENT_OVERAGE_MENU_SHOWN = 'deepseek_cli.overage_menu_shown';
...
export const EVENT_OVERAGE_OPTION_SELECTED =
  'deepseek_cli.overage_option_selected';
...
export const EVENT_EMPTY_WALLET_MENU_SHOWN =
  'deepseek_cli.empty_wallet_menu_shown';
...
export const EVENT_CREDIT_PURCHASE_CLICK = 'deepseek_cli.credit_purchase_click';
...
export const EVENT_CREDITS_USED = 'deepseek_cli.credits_used';
...
export const EVENT_API_KEY_UPDATED = 'deepseek_cli.api_key_updated';
