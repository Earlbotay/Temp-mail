...
const EVENT_CHAT_COMPRESSION = 'deepseek_cli.chat_compression';
const TOOL_CALL_COUNT = 'deepseek_cli.tool.call.count';
const TOOL_CALL_LATENCY = 'deepseek_cli.tool.call.latency';
const API_REQUEST_COUNT = 'deepseek_cli.api.request.count';
const API_REQUEST_LATENCY = 'deepseek_cli.api.request.latency';
const TOKEN_USAGE = 'deepseek_cli.token.usage';
const SESSION_COUNT = 'deepseek_cli.session.count';
const FILE_OPERATION_COUNT = 'deepseek_cli.file.operation.count';
const LINES_CHANGED = 'deepseek_cli.lines.changed';
const INVALID_CHUNK_COUNT = 'deepseek_cli.chat.invalid_chunk.count';
const CONTENT_RETRY_COUNT = 'deepseek_cli.chat.content_retry.count';
const CONTENT_RETRY_FAILURE_COUNT =
  'deepseek_cli.chat.content_retry_failure.count';
const NETWORK_RETRY_COUNT = 'deepseek_cli.network_retry.count';
const MODEL_ROUTING_LATENCY = 'deepseek_cli.model_routing.latency';
const MODEL_ROUTING_FAILURE_COUNT = 'deepseek_cli.model_routing.failure.count';
const MODEL_SLASH_COMMAND_CALL_COUNT =
  'deepseek_cli.slash_command.model.call_count';
const EVENT_HOOK_CALL_COUNT = 'deepseek_cli.hook_call.count';
const EVENT_HOOK_CALL_LATENCY = 'deepseek_cli.hook_call.latency';
const KEYCHAIN_AVAILABILITY_COUNT = 'deepseek_cli.keychain.availability.count';
const TOKEN_STORAGE_TYPE_COUNT = 'deepseek_cli.token_storage.type.count';
const OVERAGE_OPTION_COUNT = 'deepseek_cli.overage_option.count';
const CREDIT_PURCHASE_COUNT = 'deepseek_cli.credit_purchase.count';
const EVENT_ONBOARDING_START = 'deepseek_cli.onboarding.start';
const EVENT_ONBOARDING_SUCCESS = 'deepseek_cli.onboarding.success';
const EVENT_ONBOARDING_DURATION_MS = 'deepseek_cli.onboarding.duration';

// Agent Metrics
const AGENT_RUN_COUNT = 'deepseek_cli.agent.run.count';
const AGENT_DURATION_MS = 'deepseek_cli.agent.duration';
const AGENT_TURNS = 'deepseek_cli.agent.turns';
const AGENT_RECOVERY_ATTEMPT_COUNT = 'deepseek_cli.agent.recovery_attempt.count';
const AGENT_RECOVERY_ATTEMPT_DURATION =
  'deepseek_cli.agent.recovery_attempt.duration';

// Browser Agent Metrics
const BROWSER_AGENT_CONNECTION_DURATION =
  'deepseek_cli.browser_agent.connection.duration';
const BROWSER_AGENT_CONNECTION_FAILURE_COUNT =
  'deepseek_cli.browser_agent.connection.failure.count';
const BROWSER_AGENT_TOOLS_DISCOVERED =
  'deepseek_cli.browser_agent.tools.discovered';
const BROWSER_AGENT_TOOLS_MISSING_SEMANTIC =
  'deepseek_cli.browser_agent.tools.missing_semantic';
const BROWSER_AGENT_VISION_STATUS = 'deepseek_cli.browser_agent.vision.status';
const BROWSER_AGENT_TASK_OUTCOME = 'deepseek_cli.browser_agent.task.outcome';
const BROWSER_AGENT_TASK_DURATION = 'deepseek_cli.browser_agent.task.duration';
const BROWSER_AGENT_CLEANUP_DURATION =
  'deepseek_cli.browser_agent.cleanup.duration';
const BROWSER_AGENT_CLEANUP_FAILURE_COUNT =
  'deepseek_cli.browser_agent.cleanup.failure.count';
...
const STARTUP_TIME = 'deepseek_cli.startup.duration';
const MEMORY_USAGE = 'deepseek_cli.memory.usage';
const CPU_USAGE = 'deepseek_cli.cpu.usage';
const TOOL_QUEUE_DEPTH = 'deepseek_cli.tool.queue.depth';
const TOOL_EXECUTION_BREAKDOWN = 'deepseek_cli.tool.execution.breakdown';
const TOKEN_EFFICIENCY = 'deepseek_cli.token.efficiency';
const API_REQUEST_BREAKDOWN = 'deepseek_cli.api.request.breakdown';
const PERFORMANCE_SCORE = 'deepseek_cli.performance.score';
const REGRESSION_DETECTION = 'deepseek_cli.performance.regression';
const REGRESSION_PERCENTAGE_CHANGE =
  'deepseek_cli.performance.regression.percentage_change';
const BASELINE_COMPARISON = 'deepseek_cli.performance.baseline.comparison';
const FLICKER_FRAME_COUNT = 'deepseek_cli.ui.flicker.count';
const SLOW_RENDER_LATENCY = 'deepseek_cli.ui.slow_render.latency';
const EXIT_FAIL_COUNT = 'deepseek_cli.exit.fail.count';
const PLAN_EXECUTION_COUNT = 'deepseek_cli.plan.execution.count';
