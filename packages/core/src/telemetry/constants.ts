...
export const SERVICE_NAME = 'deepseek-cli';
export const SERVICE_DESCRIPTION =
  'DeepSeek CLI is an open-source AI agent that brings the power of DeepSeek directly into your terminal. It is designed to be a terminal-first, extensible, and powerful tool for developers, engineers, SREs, and beyond.';

// DeepSeek CLI specific semantic conventions
...
// DeepSeek CLI specific operations
export enum DeepSeekCliOperation {
  ToolCall = 'tool_call',
  LLMCall = 'llm_call',
