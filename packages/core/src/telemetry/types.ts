...
export const EVENT_CLI_CONFIG = 'deepseek_cli.config';
export class StartSessionEvent implements BaseTelemetryEvent {
  ...
  constructor(config: Config, toolRegistry?: ToolRegistry) {
    ...
    if (generatorConfig && generatorConfig.authType) {
      useDeepSeek = generatorConfig.authType === AuthType.USE_DEEPSEEK;
    ...
    this.api_key_enabled = useDeepSeek || useVertex;
...
export const EVENT_USER_PROMPT = 'deepseek_cli.user_prompt';
...
export const EVENT_TOOL_CALL = 'deepseek_cli.tool_call';
...
export const EVENT_API_REQUEST = 'deepseek_cli.api_request';
...
export const EVENT_API_ERROR = 'deepseek_cli.api_error';
...
export const EVENT_API_RESPONSE = 'deepseek_cli.api_response';
...
export const EVENT_FLASH_FALLBACK = 'deepseek_cli.flash_fallback';
...
export const EVENT_RIPGREP_FALLBACK = 'deepseek_cli.ripgrep_fallback';
...
export const EVENT_NEXT_SPEAKER_CHECK = 'deepseek_cli.next_speaker_check';
...
export const EVENT_CONSECA_POLICY_GENERATION =
  'deepseek_cli.conseca.policy_generation';
...
export const EVENT_CONSECA_VERDICT = 'deepseek_cli.conseca.verdict';
...
export const EVENT_SLASH_COMMAND = 'deepseek_cli.slash_command';
...
export const EVENT_REWIND = 'deepseek_cli.rewind';
...
export const EVENT_CHAT_COMPRESSION = 'deepseek_cli.chat_compression';
...
export const EVENT_IDE_CONNECTION = 'deepseek_cli.ide_connection';
...
export const EVENT_CONVERSATION_FINISHED = 'deepseek_cli.conversation_finished';
...
export const EVENT_FILE_OPERATION = 'deepseek_cli.file_operation';
...
export const EVENT_INVALID_CHUNK = 'deepseek_cli.chat.invalid_chunk';
...
export const EVENT_CONTENT_RETRY = 'deepseek_cli.chat.content_retry';
...
export const EVENT_NETWORK_RETRY_ATTEMPT = 'deepseek_cli.network_retry_attempt';
...
export const EVENT_MODEL_ROUTING = 'deepseek_cli.model_routing';
...
export const EVENT_EXTENSION_INSTALL = 'deepseek_cli.extension_install';
...
export const EVENT_TOOL_OUTPUT_TRUNCATED = 'deepseek_cli.tool_output_truncated';
...
export const EVENT_TOOL_OUTPUT_MASKING = 'deepseek_cli.tool_output_masking';
...
export const EVENT_EXTENSION_UNINSTALL = 'deepseek_cli.extension_uninstall';
...
export const EVENT_EXTENSION_UPDATE = 'deepseek_cli.extension_update';
...
export const EVENT_EXTENSION_ENABLE = 'deepseek_cli.extension_enable';
...
export const EVENT_MODEL_SLASH_COMMAND = 'deepseek_cli.slash_command.model';
...
export const EVENT_LLM_LOOP_CHECK = 'deepseek_cli.llm_loop_check';
...
export const EVENT_EXTENSION_DISABLE = 'deepseek_cli.extension_disable';
...
export const EVENT_EDIT_STRATEGY = 'deepseek_cli.edit_strategy';
...
export const EVENT_EDIT_CORRECTION = 'deepseek_cli.edit_correction';
...
export const EVENT_STARTUP_STATS = 'deepseek_cli.startup_stats';
...
export const EVENT_AGENT_START = 'deepseek_cli.agent.start';
...
export const EVENT_AGENT_FINISH = 'deepseek_cli.agent.finish';
...
export const EVENT_AGENT_RECOVERY_ATTEMPT = 'deepseek_cli.agent.recovery_attempt';
...
export const EVENT_HOOK_CALL = 'deepseek_cli.hook_call';

export const EVENT_APPROVAL_MODE_SWITCH =
  'deepseek_cli.plan.approval_mode_switch';
...
export const EVENT_APPROVAL_MODE_DURATION =
  'deepseek_cli.plan.approval_mode_duration';
...
export const EVENT_PLAN_EXECUTION = 'deepseek_cli.plan.execution';
...
export const EVENT_KEYCHAIN_AVAILABILITY = 'deepseek_cli.keychain.availability';
...
export const EVENT_ONBOARDING_START = 'deepseek_cli.onboarding.start';
...
export const EVENT_ONBOARDING_SUCCESS = 'deepseek_cli.onboarding.success';
...
export const EVENT_TOKEN_STORAGE_INITIALIZATION =
  'deepseek_cli.token_storage.initialization';
