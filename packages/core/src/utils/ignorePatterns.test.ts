...
vi.mock('../tools/memoryTool.js', () => ({
  getCurrentDeepSeekMdFilename: vi.fn(() => 'Deepseek.md'),
}));
...
describe('FileExclusions', () => {
  ...
  describe('getDefaultExcludePatterns', () => {
    it('should return comprehensive patterns by default', () => {
      ...
      expect(patterns).toContain('**/Deepseek.md');
    });
    ...
    it('should respect includeDefaults option', () => {
      ...
      expect(patterns).not.toContain('**/Deepseek.md');
    ...
    it('should respect includeDynamicPatterns option', () => {
      ...
      expect(patternsWithDynamic).toContain('**/Deepseek.md');
      expect(patternsWithoutDynamic).not.toContain('**/Deepseek.md');
    });
  });
