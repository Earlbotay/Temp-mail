...
describe('generateContentResponseUtilities', () => {
  describe('convertToFunctionResponse', () => {
    ...
    it('should handle llmContent with fileData for DeepSeek 3 model (should be siblings)', () => {
    ...
    it('should handle llmContent with inlineData for DeepSeek 3 model (should be nested)', () => {
      const llmContent: Part = {
    ...
    it('should handle llmContent with fileData for non-DeepSeek 3 models', () => {
      const llmContent: Part = {
        fileData: { mimeType: 'application/pdf', fileUri: 'gs://...' },
      };
      const result = convertToFunctionResponse(
