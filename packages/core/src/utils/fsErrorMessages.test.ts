    ...
    const testCases: FsErrorCase[] = [
      {
        ...
        path: '/etc/deepseek-cli/settings.json',
        expected:
          "Permission denied: cannot access '/etc/deepseek-cli/settings.json'. Check file permissions or run with elevated privileges.",
      },
      {
        code: 'EACCES',
        message: 'EACCES: permission denied',
