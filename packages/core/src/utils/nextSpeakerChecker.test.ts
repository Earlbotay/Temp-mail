...
import { DeepSeekChat } from '../core/deepseekChat.js';
...
describe('checkNextSpeaker', () => {
  ...
  beforeEach(() => {
    ...
    // DeepSeekChat will receive the mocked instances via the mocked GoogleGenAI constructor
