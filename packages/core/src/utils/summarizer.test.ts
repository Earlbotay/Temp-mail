...
describe('summarizers', () => {
  ...
  beforeEach(() => {
    ...
    (mockDeepSeekClient.generateContent as Mock) = vi.fn();
  ...
  describe('summarizeToolOutput', () => {
    it('should return original text if it is shorter than maxLength', async () => {
      ...
      expect(mockDeepSeekClient.generateContent).not.toHaveBeenCalled();
    });
    ...
    it('should call generateContent if text is longer than maxLength', async () => {
      ...
      expect(mockDeepSeekClient.generateContent).toHaveBeenCalledTimes(1);
    ...
    it('should return original text if generateContent throws an error', async () => {
      ...
      (mockDeepSeekClient.generateContent as Mock).mockRejectedValue(error);
...
`;
      const calledWith = (mockDeepSeekClient.generateContent as Mock).mock
        .calls[0];
