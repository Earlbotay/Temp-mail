...
import { DeepSeekChat, StreamEventType, type StreamEvent } from './deepseekChat.js';
...
describe('DeepSeekChat Network Retries', () => {
  ...
  it('should retry on SSL error during connection phase (ERR_SSL_SSLV3_ALERT_BAD_RECORD_MAC)', async () => {
    ...
    // Because retryWithBackoff is mocked and we just want to test DeepSeekChat's integration,
