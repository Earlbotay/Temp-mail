...
export function renderPreamble(options?: PreambleOptions): string {
  ...
  return options.interactive
    ? 'You are DeepSeek CLI, an interactive CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and effectively.'
    : 'You are DeepSeek CLI, an autonomous CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and effectively.';
}
...
**Context Precedence:**
- **Global (~/.deepseek/):** foundational user preferences. Apply these broadly.
