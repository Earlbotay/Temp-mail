...
describe('getIdeProcessInfo', () => {
  ...
  describe('DEEPSEEK_CLI_IDE_PID override', () => {
    it('should use DEEPSEEK_CLI_IDE_PID and fetch command on Unix', async () => {
      (os.platform as Mock).mockReturnValue('linux');
      vi.stubEnv('DEEPSEEK_CLI_IDE_PID', '12345');
    ...
    it('should use DEEPSEEK_CLI_IDE_PID and fetch command on Windows', async () => {
      (os.platform as Mock).mockReturnValue('win32');
      vi.stubEnv('DEEPSEEK_CLI_IDE_PID', '54321');
      const processes = [
        {
          ProcessId: 54321,
          ParentProcessId: 0,
