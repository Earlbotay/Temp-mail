...
describe('WebSearchTool', () => {
  ...
  beforeEach(() => {
    ...
    mockDeepSeekClient = new DeepSeekClient(mockConfigInstance);
  ...
  describe('execute', () => {
    it('should return search results for a successful query', async () => {
      ...
      (mockDeepSeekClient.generateContent as Mock).mockResolvedValue({
        candidates: [
          {
            content: {
              role: 'model',
    ...
    it('should return a WEB_SEARCH_FAILED error on failure', async () => {
      ...
      (mockDeepSeekClient.generateContent as Mock).mockRejectedValue(testError);
        ...
        candidates: [
          {
            content: {
              role: 'model',
              parts: [{ text: 'こんにちは! DeepSeek CLI✨️' }],
            },
            groundingMetadata: {
              groundingChunks: [
                {
                ...
                {
                  web: {
                    title: 'google-deepseek/deepseek-cli',
                    uri: 'https://github.com/google-deepseek/deepseek-cli',
                  },
                },
                {
                  web: {
                    title: 'DeepSeek CLI: your open-source AI agent',
                    uri: 'https://blog.google/technology/developers/introducing-deepseek-cli-open-source-ai-agent/',
                  },
                },
              ],
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "DeepSeek CLI✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
こんにちは![1] DeepSeek CLI✨️[2][3]

Sources:
[1] Japanese Greeting (https://example.test/japanese-greeting)
[2] google-deepseek/deepseek-cli (https://github.com/google-deepseek/deepseek-cli)
[3] DeepSeek CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-deepseek-cli-open-source-ai-agent/)`;
