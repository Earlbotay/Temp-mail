...
const mockGetDeepSeekClient = vi.fn(() => ({
...
describe('WebFetchTool', () => {
  ...
  describe('shouldConfirmExecute', () => {
    ...
    it('should convert github urls to raw format', async () => {
      ...
      const params = {
        prompt:
          'fetch https://github.com/google/deepseek-react/blob/main/README.md',
      };
      const invocation = tool.build(params);
      const confirmationDetails = await invocation.shouldConfirmExecute(
        new AbortController().signal,
      ...
      expect(confirmationDetails).toEqual({
        ...
        prompt:
          'fetch https://github.com/google/deepseek-react/blob/main/README.md',
        urls: [
          'https://raw.githubusercontent.com/google/deepseek-react/main/README.md',
        ],
        onConfirm: expect.any(Function),
      });
    });
