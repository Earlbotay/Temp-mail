...
export class McpClientManager {
   ...
   *    - Updates the DeepSeek chat configuration to load the new tools.
   */
  async stopExtension(extension: DeepSeekCLIExtension) {
   ...
   *    - Updates the DeepSeek chat configuration to load the new tools.
   */
  async startExtension(extension: DeepSeekCLIExtension) {
   ...
   * deepseek settings or command line arguments).
   *
