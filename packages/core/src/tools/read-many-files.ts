...
export interface ReadManyFilesParams {
  ...
  /**
   * Whether to respect .gitignore and .deepseekignore patterns (optional, defaults to true)
   */
  file_filtering_options?: {
    respect_git_ignore?: boolean;
    respect_deepseek_ignore?: boolean;
  };
}
 ...
 * This combines the shared patterns with dynamic patterns like Deepseek.md.
...
${finalExclusionPatternsForDescription
  ...
  async execute(signal: AbortSignal): Promise<ToolResult> {
      ...
      const { filteredPaths, ignoredCount } =
        fileDiscovery.filterFilesWithReport(relativeEntries, {
          ...
          respectDeepSeekIgnore:
            this.params.file_filtering_options?.respect_deepseek_ignore ??
            this.config.getFileFilteringOptions().respectDeepSeekIgnore ??
    ...
    // one, preventing shared parent Deepseek.md files from being injected twice.
