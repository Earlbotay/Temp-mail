...
const Platform = {
  ...
  getExternalBlockedPath() {
    return this.isWindows
      ...
      : '/Users/Shared/.deepseek_test_blocked';
  },
};
...
describe('SandboxManager Integration', () => {
   ...
   */
  function createTempDir(prefix = 'deepseek-sandbox-test-'): string {
  ...
  describe('Basic Execution', () => {
    ...
    // The Windows sandbox wrapper (DeepSeekSandbox.exe) uses standard pipes
