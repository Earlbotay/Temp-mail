...
describe('SessionSummaryService', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should handle maxMessages limit correctly', async () => {
      const messages: MessageRecord[] = Array.from({ length: 30 }, (_, i) => ({
        id: `${i}`,
        timestamp: '2025-12-03T00:00:00Z',
        type: i % 2 === 0 ? ('user' as const) : ('deepseek' as const),
  ...
  describe('Message Type Filtering', () => {
    it('should include only user and deepseek messages', async () => {
      const messages: MessageRecord[] = [
        {
          id: '1',
          timestamp: '2025-12-03T00:00:00Z',
        ...
        },
        {
          ...
          timestamp: '2025-12-03T00:01:00Z',
          type: 'deepseek',
          content: [{ text: 'DeepSeek response' }],
        },
      ];
      ...
      expect(promptText).toContain('Assistant: DeepSeek response');
    });
    ...
    it('should handle mixed message types correctly', async () => {
      ...
      expect(promptText).toContain('Assistant: DeepSeek answer');
  ...
  describe('Sliding Window Message Selection', () => {
    ...
    it('should not count system messages when calculating window', async () => {
      const messages: MessageRecord[] = [
        // First 10 user/deepseek messages
        ...
        // Last 40 user/deepseek messages
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle conversation with only deepseek messages', async () => {
      const messages: MessageRecord[] = [
        {
          id: '1',
          timestamp: '2025-12-03T00:00:00Z',
