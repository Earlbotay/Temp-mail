...
/**
 * A native C# helper for the DeepSeek CLI sandbox on Windows.
...
public class DeepSeekSandbox {
    ...
    static int Main(string[] args) {
        if (args.Length < 3) {
            Console.Error.WriteLine("Usage: DeepSeekSandbox.exe <network:0|1> <cwd> [--forbidden-manifest <path>] <command> [args...]");
