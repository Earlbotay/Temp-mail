...
export class AgentRegistry {
  ...
  private async loadAgents(): Promise<void> {
    ...
    // Load user-level agents: ~/.deepseek/agents/
    ...
    // Load project-level agents: .deepseek/agents/ (relative to Project Root)
  ...
  private loadBuiltInAgents(): void {
    ...
    // The agent declares its own workspaceDirectories (e.g. ~/.deepseek) which are
