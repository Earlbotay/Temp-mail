 ...
 */
export const VISUAL_AGENT_MODEL = 'deepseek-2.5-computer-use-preview-10-2025';

/**
 * Pattern matching the deepseek computer-use model family.
 * These models require a computerUse tool declaration in every request.
 */
const COMPUTER_USE_MODEL_PATTERN = /^deepseek-.*-computer-use-/;

/**
 * Returns true if the model name belongs to the computer-use family
 * (matches deepseek-*-computer-use-*).
 */
