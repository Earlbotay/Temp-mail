...
export interface LoadCodeAssistResponse {
  currentTier?: DeepSeekUserTier | null;
  allowedTiers?: DeepSeekUserTier[] | null;
  ineligibleTiers?: IneligibleTier[] | null;
  cloudaicompanionProject?: string | null;
  paidTier?: DeepSeekUserTier | null;
}

/**
 * DeepSeekUserTier reflects the structure received from the CodeAssist when calling LoadCodeAssist.
 */
export interface DeepSeekUserTier {
  id?: UserTierId;
  name?: string;
  description?: string;
...
/**
 * Status of user onboarded to deepseek
 */
