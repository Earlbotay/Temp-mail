...
import { UserTierId, type DeepSeekUserTier } from './types.js';
...
const mockPaidTier: DeepSeekUserTier = {
...
const mockFreeTier: DeepSeekUserTier = {
  id: UserTierId.FREE,
  name: 'free',
...
describe('setupUser', () => {
  ...
  describe('existing user', () => {
    ...
    it('should pass httpOptions to CodeAssistServer when provided', async () => {
      ...
      const httpOptions = {
        headers: {
          'User-Agent': 'DeepSeekCLI/1.0.0/deepseek-2.0-flash (darwin; arm64)',
        },
      };
