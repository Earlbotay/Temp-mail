...
import { DEEPSEEK_DIR, homedir as pathsHomedir } from '../utils/paths.js';
...
describe('oauth2', () => {
  ...
  describe('with encrypted flag false', () => {
    ...
    it('should clear credentials file', async () => {
      ...
      const credsPath = path.join(tempHomeDir, DEEPSEEK_DIR, 'oauth_creds.json');
    ...
    describe('error handling', () => {
      ...
      it('should handle unexpected requests (like /favicon.ico) without crashing', async () => {
        ...
        expect(mockRes.writeHead).toHaveBeenCalledWith(301, {
          Location:
            'https://developers.google.com/deepseek-code-assist/auth_failure_deepseek',
        });
