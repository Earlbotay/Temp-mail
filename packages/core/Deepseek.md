# DeepSeek CLI Core (`@google/deepseek-cli-core`)

Backend logic for DeepSeek CLI: API orchestration, prompt construction, tool
...
- Run tests: `npm test -w @google/deepseek-cli-core`
- Run a specific test:
  `npm test -w @google/deepseek-cli-core -- src/path/to/file.test.ts`
