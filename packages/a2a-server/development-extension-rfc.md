# RFC: DeepSeek CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the DeepSeek CLI agent, this document
...
required for rich, interactive workflows with the DeepSeek CLI agent.

### 1.2 Motivation

Recent work integrating DeepSeek CLI with clients like Zed and DeepSeek Code
...
- **Ecosystem Alignment**: Aligns DeepSeek CLI with a growing industry standard,
...
workflows between a client and the DeepSeek CLI agent. It consists of a
...
```json
{
  ...
  "capabilities": {
    ...
    "extensions": [
      {
        "uri": "https://github.com/google-deepseek/deepseek-cli/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the DeepSeek CLI agent.
...
This method allows the client to discover slash commands supported by DeepSeek
