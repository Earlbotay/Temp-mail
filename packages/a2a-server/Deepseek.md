# DeepSeek CLI A2A Server (`@google/deepseek-cli-a2a-server`)

Experimental Agent-to-Agent (A2A) server that exposes DeepSeek CLI capabilities
...
- Binary entry point: `deepseek-cli-a2a-server`

## Testing

- Run tests: `npm test -w @google/deepseek-cli-a2a-server`
