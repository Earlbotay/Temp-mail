...
export function createMockConfig(
  ...
  const mockConfig = {
    ...
    get deepseekClient() {
      ...
      const config = this as unknown as Config;
      // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
      return config.getDeepSeekClient?.() as unknown as DeepSeekClient;
    },
    ...
    getContentGeneratorConfig: vi.fn().mockReturnValue({ model: 'deepseek-pro' }),
  ...
  mockConfig.getDeepSeekClient = vi
    .fn()
    .mockReturnValue(new DeepSeekClient(mockConfig));
