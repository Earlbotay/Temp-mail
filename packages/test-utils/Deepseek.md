# DeepSeek CLI Test Utils (`@google/deepseek-cli-test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from '@google/deepseek-cli-test-utils';
...
Import from `@google/deepseek-cli-test-utils` in test files across the monorepo.
