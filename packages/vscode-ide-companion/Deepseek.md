# DeepSeek CLI VS Code Companion (`deepseek-cli-vscode-ide-companion`)

VS Code extension that pairs with DeepSeek CLI, providing direct IDE workspace
...
- Run tests: `npm test -w deepseek-cli-vscode-ide-companion`
